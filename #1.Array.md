...
5 |Maximum Product Subarray in an Array | prefix and suffix product | O(n) | O(1) |
6 | Merge two sorted arrays without extra space | Compare ends pointers as array is sorted | O(n + m) | O(1) |
